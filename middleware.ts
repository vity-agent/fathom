...
const ROUTES: Record<string, { price: string; description: string }> = {
  "/api/observations": { price: "0.40", description: "Get economic data observations for any FRED series" },
  "/api/search": { price: "0.40", description: "Search 816,000+ FRED economic time series" },
  "/api/series": { price: "0.40", description: "Get FRED series metadata" },
  "/api/categories": { price: "0.35", description: "Browse FRED data categories" },
  "/api/popular": { price: "0.35", description: "20 most-watched macroeconomic indicators" },
  "/api/releases": { price: "0.40", description: "Federal Reserve data release schedule" },
  "/api/category-series": { price: "0.40", description: "Series within a FRED category" },
  "/api/tags": { price: "0.35", description: "Browse FRED data tags" },
  "/api/tag-series": { price: "0.40", description: "Series matching a tag" },
  "/api/release-series": { price: "0.40", description: "Series within a data release" },
  "/api/release-dates": { price: "0.40", description: "Release dates for a FRED release" },
  "/api/bulk": { price: "0.35", description: "Multi-series fetch in one call" },
  "/api/compare": { price: "0.35", description: "Compare 2-5 series side by side" },
  "/api/latest": { price: "0.35", description: "Latest value for a FRED series" },
  "/api/calendar": { price: "0.25", description: "Economic release calendar" },
  "/api/snapshot": { price: "0.40", description: "Dashboard of 10 key US economic indicators" },
  "/api/sources": { price: "0.35", description: "FRED data sources list" },
  "/api/category-tags": { price: "0.35", description: "Tags for a FRED category" },
  "/api/series-tags": { price: "0.35", description: "Tags for a FRED series" },
  "/api/search-tags": { price: "0.35", description: "Search FRED tags" },
  "/api/vintage": { price: "0.40", description: "Vintage/revision dates for a series" },
  "/api/related": { price: "0.35", description: "Related categories for a series" },
  "/api/category-tree": { price: "0.35", description: "Browse FRED category tree" },
};
